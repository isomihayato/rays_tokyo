...
<div class="container" style="max-width: 90vw;margin:0 auto;">
  <div class="row">
    <div class="col-sm-8 blog_body">
      <h2 class="blog__title">{{$this_category[0]->title}}ブログ記事一覧</h2>
      <ul class="blog_list">
        ...
        <li>
          ...
          <dl class="blogdata">
            ...
            <dd><a href="/blog/{{$article->id}}">この記事のURL</a></dd>
          </dl>
          <div class="box_blogtext">
            <img src="{{$article->thumbnail}}" class="catch_img" />
            <p>{!! mb_strcut(strip_tags(str_replace("\r\n", '', $article->body)),0,350); !!}......</p>
            <p class="blog_button clearfix"><a href="/blog/{{$article->id}}">記事を開く</a></p>
          </div>
        </li>
        @endforeach
      </ul>
