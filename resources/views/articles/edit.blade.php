...
<div class="container">
  ...
  <div class="row mt-3 mb-3">
      <div class="col-6">
        ...
        {!! Form::select('category',$categories,$article->category_id) !!}
      </div>
  </div>
  <div class="row mt-3 mb-3">
      <div class="col-6">
  ...
  <div class="row mt-3 mb-3">
      <div class="col-6">
        ...
        <input type="datetime-local" name="release_at" value="{{(new DateTime($article->release_at))->format("Y-m-d\TH:i")}}" id="release_at">
      </div>
  </div>
  <div class="row mt-3 mb-3">
      <div class="col-6">
